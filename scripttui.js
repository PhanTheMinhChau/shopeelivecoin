      ...
      card.innerHTML = `
        <div class="top-row">
          ...
          <div class="button-section">
            <button onclick="window.location.href='https://shopee.vn/universal-link/shop/${item.shopId}?utm_source=an_17396220028&utm_medium=affiliates&utm_campaign=-&utm_content=acc48----&utm_term=cbd7y5mvixm5;'">Vào ngay</button>
          </div>
        </div>
